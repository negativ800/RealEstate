...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <!-- Item 2 -->
        <div class="item">
          <img src="{{ asset('images/properties/2.jpg') }}" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="{{ asset('images/properties/1.jpg') }}" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="{{ asset('images/properties/3.jpg') }}" class="properties" alt="properties" />
